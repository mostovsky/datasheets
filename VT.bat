...
if "%to_find%"=="search" (
	...
	REM search-ms:displayname=Some%20search%20in%20"[datasheets]"&crumb=ËÏˇÙ‡ÈÎ‡%3A~~*irfp%20»À»%20System.Generic.String%3A*irfp&crumb=location:H%3A%5Cdata%5C[datasheets]
	REM set "ExplorerFindString=search-ms^:displayname=Some%%^20search%%^20in%%^20^"^[datasheets^]^"^&crumb^=ËÏˇÙ‡ÈÎ‡%%^3A^~^~^*!TextToSearch!%%^20»À»%%^20System.Generic.String%%^3A^*!TextToSearch!^&crumb^=location^:!LocationPath!"
	...
	REM echo "search-ms^:displayname=Some%%^20search%%^20in%%^20^"^[datasheets^]^"^&crumb^=ËÏˇÙ‡ÈÎ‡%%^3A^~^~^*!TextToSearch!%%^20»À»%%^20System.Generic.String%%^3A^*!TextToSearch!^&crumb^=location^:!LocationPath!"
